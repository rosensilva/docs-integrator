...
Connectors created this way are added directly to your project. To make one reusable across projects, publish it to an organization registry — see [Build your own connector](../../../connectors/build-your-own/build-own.md) and [Publish to Central](../../../connectors/publish-ballerina-central.md).
