...
3. Open the flow and [add a step](/docs/develop/understand-ide/editors/flow-diagram-editor).
...
1. Add and configure the required connector under **Connections**. For brokered messages, select the relevant connector, such as the [NATS connector](/docs/connectors/catalog/messaging/nats/connector-overview), from the [messaging connector catalog](/docs/connectors/catalog/messaging).
