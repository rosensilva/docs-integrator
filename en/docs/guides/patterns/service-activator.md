...
6. Configure the RabbitMQ queue and listener values with [configurable variables](/docs/develop/integration-artifacts/supporting/configurations).
...
4. Configure the listener, queue, and authentication fields with [configurable variables](/docs/develop/integration-artifacts/supporting/configurations).
