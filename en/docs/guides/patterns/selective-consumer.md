...
2. Configure the listener connection with the broker endpoint and credentials through [configurable variables](/docs/develop/integration-artifacts/supporting/configurations).
...
2. Open the message handler flow and [add a step](/docs/develop/understand-ide/editors/flow-diagram-editor).
